...
Goal: reduce Integration Test duration, it feels already too long, although we are only half way of the Roadmap.
Explore possibility to fire only 1 instance of the app for IT such as in Quarkus, reduce number of test, factorize test
and any other Spring Boot tests Optimizations.
