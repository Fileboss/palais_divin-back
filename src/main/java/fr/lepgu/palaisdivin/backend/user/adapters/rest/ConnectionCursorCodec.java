...
final class ConnectionCursorCodec {

  private static final int VERSION = 1;
  private static final ObjectMapper MAPPER = new ObjectMapper();

  private ConnectionCursorCodec() {}

  static String encode(ConnectionCursor cursor) {
    try {
      String json =
          MAPPER
              .createObjectNode()
  ...
  static ConnectionCursor decode(String token) {
    byte[] raw;
    try {
    ...
    return new ConnectionCursor(createdAt, new ConnectionId(uuid));
  }
}
